...
#define VMCS_FIELD_ENTRIES                                                     \
  ...
  MASK(VMCS_FIELD(VMCS_CTRL_POSTED_INT_N_VECTOR))                              \
  MASK(VMCS_FIELD(VMCS_CTRL_EPTP_INDEX))                                       \
  ...
  MASK(VMCS_FIELD(VMCS_GUEST_INT_STATUS))                                      \
  ...
  MASK(VMCS_FIELD(VMCS_CTRL_IO_BITMAP_A))                                      \
  MASK(VMCS_FIELD(VMCS_CTRL_IO_BITMAP_B))                                      \
  MASK(VMCS_FIELD(VMCS_CTRL_MSR_BITMAPS))                                      \
  MASK(VMCS_FIELD(VMCS_CTRL_VMEXIT_MSR_STORE_ADDR))                            \
  MASK(VMCS_FIELD(VMCS_CTRL_VMEXIT_MSR_LOAD_ADDR))                             \
  MASK(VMCS_FIELD(VMCS_CTRL_VMENTRY_MSR_LOAD_ADDR))                            \
  MASK(VMCS_FIELD(VMCS_CTRL_EXECUTIVE_VMCS_PTR))                               \
  VMCS_FIELD(VMCS_CTRL_TSC_OFFSET)                                             \
  MASK(VMCS_FIELD(VMCS_CTRL_VIRTUAL_APIC))                                     \
  MASK(VMCS_FIELD(VMCS_CTRL_APIC_ACCESS))                                      \
  MASK(VMCS_FIELD(VMCS_CTRL_POSTED_INT_DESC_ADDR))                             \
  MASK(VMCS_FIELD(VMCS_CTRL_VMFUNC_CTRL))                                      \
  MASK(VMCS_FIELD(VMCS_CTRL_EPTP))                                             \
  MASK(VMCS_FIELD(VMCS_CTRL_EOI_EXIT_BITMAP_0))                                \
  MASK(VMCS_FIELD(VMCS_CTRL_EOI_EXIT_BITMAP_1))                                \
  MASK(VMCS_FIELD(VMCS_CTRL_EOI_EXIT_BITMAP_2))                                \
  MASK(VMCS_FIELD(VMCS_CTRL_EOI_EXIT_BITMAP_3))                                \
  MASK(VMCS_FIELD(VMCS_CTRL_EPTP_LIST_ADDR))                                   \
  MASK(VMCS_FIELD(VMCS_CTRL_VMREAD_BITMAP_ADDR))                               \
  MASK(VMCS_FIELD(VMCS_CTRL_VMWRITE_BITMAP_ADDR))                              \
  MASK(VMCS_FIELD(VMCS_CTRL_VIRT_EXC_INFO_ADDR))                               \
  MASK(VMCS_FIELD(VMCS_CTRL_XSS_EXITING_BITMAP))                               \
  MASK(VMCS_FIELD(VMCS_GUEST_PHYSICAL_ADDRESS))                                \
  MASK(VMCS_FIELD(VMCS_GUEST_LINK_POINTER))                                    \
  VMCS_FIELD(VMCS_GUEST_IA32_DEBUGCTL)                                         \
  MASK(VMCS_FIELD(VMCS_GUEST_IA32_PAT))                                        \
  VMCS_FIELD(VMCS_GUEST_IA32_EFER)                                             \
  MASK(VMCS_FIELD(VMCS_GUEST_IA32_PERF_GLOBAL_CTRL))                           \
  ...
  MASK(VMCS_FIELD(VMCS_CTRL_VMEXIT_MSR_STORE_COUNT))                           \
  MASK(VMCS_FIELD(VMCS_CTRL_VMEXIT_MSR_LOAD_COUNT))                            \
  VMCS_FIELD(VMCS_CTRL_VMENTRY_CONTROLS)                                       \
  MASK(VMCS_FIELD(VMCS_CTRL_VMENTRY_MSR_LOAD_COUNT))                           \
  ...
  MASK(VMCS_FIELD(VMCS_GUEST_SMBASE))                                          \
  VMCS_FIELD(VMCS_GUEST_IA32_SYSENTER_CS)                                      \
  VMCS_FIELD(VMCS_GUEST_VMX_TIMER_VALUE)                                       \
  MASK(VMCS_FIELD(VMCS_HOST_IA32_SYSENTER_CS))                                 \
